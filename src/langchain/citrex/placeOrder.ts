...
const CitrexPlaceOrderInputSchema = z.object({
    ...
    priceIncrement: z.number().optional().describe("The price precision for the product (required for MARKET orders) find it in the product info under the 'increment' key"),
