...
export class SeiCitrexGetOrderBookTool extends StructuredTool<typeof CitrexGetOrderBookInputSchema> {
  ...
  description = "Retrieves the order book for a product from the Citrex Protocol. The symbol must be a valid product symbol from the Citrex Protocol. Example: ETH -> 'ethperp', BTC -> 'btcperp', etc.";
